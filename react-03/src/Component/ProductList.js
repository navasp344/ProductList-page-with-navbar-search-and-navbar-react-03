...
function ProductList(props) {
  const productdata = [
    ...
    },
    {
      ...
      brand: "luxury palace",
      category: "home-decoration",
      thumbnail: "https://cdn.dummyjson.com/product-images/29/2.jpg",
      images: [
...
const serched=props.searching;
  const filteredproductdata=productdata.filter((p)=>{
    return p.title.toLowerCase().includes(serched.toLowerCase())
